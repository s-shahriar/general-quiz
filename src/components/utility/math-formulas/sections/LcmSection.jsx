    ...
    <div className="mf-section" id="lcm">
      ...
      <Card color="gold" style={{marginTop:14}}>
        ...
        <IdItem n="১">
          ...
          <div style={exBox}><strong>উদাহরণ:</strong> কোন <strong>ক্ষুদ্রতম</strong> সংখ্যাকে <strong>১৩, ১৮, ২১</strong> দিয়ে ভাগ করলে প্রতিবার <strong>২</strong> অবশিষ্ট থাকবে? → (১৩, ১৮, ২১-এর ল.সা.গু) <strong>+ ২</strong>।</div>
        </IdItem>
        ...
        <IdItem n="২">
          ...
          <div style={exBox}><strong>উদাহরণ:</strong> কোন <strong>ক্ষুদ্রতম</strong> সংখ্যাকে <strong>১২, ১৫, ১৬</strong> দিয়ে ভাগ করলে যথাক্রমে <strong>৫, ৮, ৯</strong> অবশিষ্ট থাকবে? (১২−৫ = ১৫−৮ = ১৬−৯ = <strong>৭</strong>) → (১২, ১৫, ১৬-এর ল.সা.গু) <strong>− ৭</strong>।</div>
        </IdItem>
