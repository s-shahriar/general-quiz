    ...
    <div className="mf-section" id="line">
      ...
      <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(min(100%,300px),1fr))',gap:12}}>
        ...
        <Card color="violet">
          ...
          <div style={{padding:'12px 14px',borderRadius:10,background:'color-mix(in srgb, var(--mf-violet) 10%, transparent)',border:'1px solid color-mix(in srgb, var(--mf-violet) 30%, transparent)'}}>
            ...
            <div style={{display:'flex',flexWrap:'wrap',gap:6,alignItems:'center',fontSize:12,color:'var(--text-3)'}}>
              ...
              <code style={{background:'color-mix(in srgb, var(--mf-violet) 15%, transparent)',padding:'2px 7px',borderRadius:5,color:'var(--mf-violet)',fontWeight:700}}>3/2 = 2k/5</code>
              <span>→ k = 15/4</span>
            </div>
          </div>
        </Card>
