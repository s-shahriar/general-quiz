...
const sheet = { position: 'relative', width: '100%', maxWidth: 340, background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 16, padding: '28px 24px 24px', textAlign: 'center', boxShadow: '0 20px 60px rgba(0,0,0,0.3)' }
...
const icon = { width: 52, height: 52, borderRadius: '50%', background: 'color-mix(in srgb, var(--accent) 15%, transparent)', color: 'var(--accent)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 14px' }
