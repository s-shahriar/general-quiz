...
const dropdown = { position: 'absolute', top: 'calc(100% + 10px)', right: 0, zIndex: 1001, width: 256, padding: 14, borderRadius: 14, background: 'var(--card)', border: '1px solid var(--border)', boxShadow: '0 16px 44px rgba(0,0,0,0.22)' }
