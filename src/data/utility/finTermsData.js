...
export const FIN_CATEGORIES = {
  "বাংলাদেশ ব্যাংক":      "var(--topic-5)",
  "ব্যাংকিং টার্ম":        "var(--topic-8)",
  "আমানত ও ঋণ":           "var(--topic-3)",
  "আর্থিক বাজার":          "var(--topic-11)",
  "পূর্ণরূপ":              "var(--topic-8)",
  "মানি লন্ডারিং":         "var(--topic-1)",
  "ক্রেডিট ইন্সট্রুমেন্ট": "var(--topic-10)",
  "বিবিধ":                 "var(--text-3)",
}
...
export const FIN_CARDS = [
  {
    ...
    title: "CAMELS Rating", subtitle: "ব্যাংক মূল্যায়ন পদ্ধতি", icon: Star,
  ...
  },
  {
    ...
    title: "বাংলাদেশ ব্যাংক — পরিচিতি", subtitle: "মূল তথ্য", icon: Building2,
  ...
  },
  {
    ...
    title: "সরকারি নোট ও ব্যাংক নোট", subtitle: "নোটের পার্থক্য", icon: Banknote,
  ...
  },
  {
    ...
    title: "SRR / CRR / SLR", subtitle: "রিজার্ভ রেট", icon: BarChart2,
  ...
  },
  {
    ...
    title: "ব্যাংকের শ্রেণীবিভাগ", subtitle: "বাংলাদেশের ব্যাংক", icon: Landmark,
  ...
  },
  {
    ...
    title: "Green Bank — 4R", subtitle: "সবুজ ব্যাংকিং", icon: Leaf,
    body: `সবুজ ব্যাংক বা Green Banking হলো পরিবেশবান্ধব ব্যাংকিং কার্যক্রম।<br><br><strong>4R মানে:</strong><br><strong>Reduce</strong> — সম্পদ ও শক্তির ব্যবহার কমানো<br><strong>Reuse</strong> — সম্পদের পুনর্ব্যবহার<br><strong>Recycle</strong> — বর্জ্যকে পুনরায় কাজে লাগানো<br><strong>Refuse</strong> — ক্ষতিকর ও অপ্রয়োজনীয় পণ্য প্রত্যাখ্যান করা<br><br><em class="warning">Note: Rethink নয়, সঠিক হলো Refuse</em>`,
  },
  {
    id: 7, cat: "ব্যাংকিং টার্ম",
    title: "SWIFT", subtitle: "আন্তর্ব্যাংক বার্তা নেটওয়ার্ক", icon: Globe,
    body: `<strong>পূর্ণরূপ:</strong> Society for Worldwide Interbank Financial Telecommunication<br><br>বিশ্বব্যাপী ব্যাংকগুলোর মধ্যে <em>আর্থিক লেনদেন সংক্রান্ত বার্তা নিরাপদে আদান-প্রদানের</em> নেটওয়ার্ক।<br><br><strong class="warning">গুরুত্বপূর্ণ:</strong> SWIFT নিজে <em>কোনো টাকা স্থানান্তর করে না</em> — শুধুমাত্র <strong>Payment Order পাঠায়।</strong><br><br><strong>ব্যবহার:</strong> বিদেশে রেমিট্যান্স, LC, আন্তর্জাতিক ট্রেড পেমেন্ট।<br><em>প্রতিষ্ঠা: ১৯৭৩, সদর দপ্তর: বেলজিয়াম</em>`,
  },
  {
    id: 8, cat: "ব্যাংকিং টার্ম",
    title: "REPO", subtitle: "Repurchase Agreement", icon: RefreshCw,
  ...
  },
  {
    ...
    title: "ALCO", subtitle: "Asset Liability Committee", icon: Scale,
  ...
  },
  {
    ...
    title: "Treasury Bill", subtitle: "টি-বিল", icon: FileText,
  ...
  },
  {
    ...
    title: "Shell Bank", subtitle: "শেল ব্যাংক", icon: Layers,
  ...
  },
  {
    ...
    title: "Window Dressing", subtitle: "উইন্ডো ড্রেসিং", icon: Eye,
  ...
  },
  {
    ...
    title: "Off-shore Banking", subtitle: "অফশোর ব্যাংকিং", icon: Waves,
  ...
  },
  {
    ...
    title: "Hard ও Soft Currency", subtitle: "মুদ্রার শ্রেণীভেদ", icon: ArrowLeftRight,
  ...
  },
  {
    ...
    title: "Nostro ও Vostro Account", subtitle: "আন্তর্জাতিক ব্যাংক হিসাব", icon: Globe,
  ...
  },
  {
    ...
    title: "স্প্রেড (Spread)", subtitle: "সুদের ব্যবধান", icon: Ruler,
  ...
  },
  {
    ...
    title: "মর্টগেজ (Mortgage)", subtitle: "সম্পত্তি বন্ধক", icon: Home,
  ...
  },
  {
    ...
    title: "LC — Letter of Credit", subtitle: "ঋণপত্র", icon: FileText,
  ...
  },
  {
    ...
    title: "Assignment, Hypothecation ও Pledge", subtitle: "জামানতের ধরন", icon: ClipboardList,
  ...
  },
  {
    ...
    title: "Demand ও Time Deposit", subtitle: "আমানতের প্রকারভেদ", icon: Building2,
  ...
  },
  {
    ...
    title: "Negotiable Instruments", subtitle: "হস্তান্তরযোগ্য দলিল", icon: FileText,
  ...
  },
  {
    ...
    title: "Crossed Cheque", subtitle: "ক্রস করা চেক", icon: CheckSquare,
  ...
  },
  {
    ...
    title: "Demand Draft ও Bill of Exchange", subtitle: "ব্যাংকিং দলিল", icon: Files,
  ...
  },
  {
    ...
    title: "Promissory Note", subtitle: "প্রতিশ্রুতি নোট", icon: PenLine,
  ...
  },
  {
    ...
    title: "Money Market — Instruments", subtitle: "মুদ্রা বাজারের হাতিয়ার", icon: DollarSign,
  ...
  },
  {
    ...
    title: "Capital Market — Instruments", subtitle: "পুঁজিবাজারের হাতিয়ার", icon: TrendingUp,
  ...
  },
  {
    ...
    title: "Dividend", subtitle: "লভ্যাংশ", icon: Banknote,
  ...
  },
  {
    ...
    title: "সুকুক (Sukuk)", subtitle: "ইসলামিক বন্ড", icon: Star,
  ...
  },
  {
    ...
    title: "মুদ্রাস্ফীতি", subtitle: "Inflation", icon: BarChart2,
  ...
  },
  {
    ...
    title: "ডাম্পিং (Dumping)", subtitle: "অনুচিত বাণিজ্য প্রতিযোগিতা", icon: Package,
  ...
  },
  {
    ...
    title: "বিটকয়েন (Bitcoin)", subtitle: "ক্রিপ্টোকারেন্সি", icon: Bitcoin,
  ...
  },
  {
    ...
    title: "মানি লন্ডারিং — ৩ ধাপ", subtitle: "অর্থ পাচারের প্রক্রিয়া", icon: AlertTriangle,
  ...
  {
    id: 33, cat: "পূর্ণরূপ",
    title: "Abbreviations — সেট ১", subtitle: "SWIFT থেকে RTGS", icon: Hash,
  ...
  {
    id: 34, cat: "পূর্ণরূপ",
    title: "Abbreviations — সেট ২", subtitle: "BEFTN থেকে CSR", icon: Hash,
  ...
  {
    id: 35, cat: "পূর্ণরূপ",
    title: "Abbreviations — সেট ৩", subtitle: "BRPD থেকে CIB", icon: Hash,
  ...
  },
  {
    ...
    title: "CTR — নগদ লেনদেন প্রতিবেদন", subtitle: "Cash Transaction Report", icon: Banknote,
  ...
  },
  {
    ...
    title: "STR — সন্দেহজনক লেনদেন প্রতিবেদন", subtitle: "Suspicious Transaction Report", icon: AlertTriangle,
  ...
  },
  {
    ...
    title: "BFIU", subtitle: "Bangladesh Financial Intelligence Unit", icon: Search,
  ...
  },
  {
    ...
    title: "KYC — Know Your Customer", subtitle: "গ্রাহক পরিচিতি যাচাই", icon: CreditCard,
  ...
  },
  {
    ...
    title: "RTGS ও BEFTN", subtitle: "ইলেকট্রনিক ফান্ড ট্রান্সফার", icon: Zap,
  ...
  },
  {
    ...
    title: "CIB — ক্রেডিট ইনফরমেশন ব্যুরো", subtitle: "Credit Information Bureau", icon: Folder,
  ...
  },
  {
    ...
    title: "NPL / খেলাপি ঋণ", subtitle: "Non-Performing Loan", icon: AlertCircle,
  ...
  },
  {
    ...
    title: "Pay Order (PO)", subtitle: "পে অর্ডার", icon: Receipt,
  ...
  },
  {
    ...
    title: "Basel II ও Basel III", subtitle: "আন্তর্জাতিক ব্যাংকিং মানদণ্ড", icon: Landmark,
  ...
  },
  {
    ...
    title: "Micro Finance ও MFI", subtitle: "ক্ষুদ্রঋণ", icon: Users,
  ...
  },
  {
    ...
    title: "মুদ্রানীতি", subtitle: "Monetary Policy", icon: Target,
  ...
  },
  {
    ...
    title: "DSE ও CSE", subtitle: "বাংলাদেশের স্টক এক্সচেঞ্জ", icon: TrendingDown,
  ...
  },
  {
    ...
    title: "সঞ্চয়পত্র (Sanchayapatra)", subtitle: "সরকারি সঞ্চয় প্রকল্প", icon: Award,
  ...
  },
  {
    ...
    title: "Offshore Banking Unit (OBU)", subtitle: "বাংলাদেশে অফশোর ব্যাংকিং", icon: Waves,
  ...
  },
  {
    ...
    title: "Weightage", subtitle: "আনুপাতিক গুরুত্ব", icon: Scale,
  ...
  },
  {
    ...
    title: "বাংলাদেশ ব্যাংকের কাজ", subtitle: "Central Bank Functions", icon: Building2,
    body: `<strong>মূল কাজসমূহ:</strong><br><strong>নোট ইস্যু</strong> — একমাত্র নোট ছাপানোর অধিকার<br><strong>মুদ্রানীতি</strong> — সুদের হার ও মুদ্রা সরবরাহ নিয়ন্ত্রণ<br><strong>ব্যাংকের ব্যাংকার</strong> — বাণিজ্যিক ব্যাংকের শেষ আশ্রয়স্থল (Lender of Last Resort)<br><strong>সরকারের ব্যাংকার</strong> — সরকারের হিসাব পরিচালনা<br><strong>তত্ত্বাবধান</strong> — সকল ব্যাংক ও আর্থিক প্রতিষ্ঠান নিয়ন্ত্রণ<br><strong>বৈদেশিক মুদ্রা</strong> — মজুত ব্যবস্থাপনা ও বিনিময় হার নিয়ন্ত্রণ`,
  },
]
